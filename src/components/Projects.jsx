        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-[#ccd6f6] max-w-2xl mx-auto">
              From interactive games to practical tools, here's a collection of
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="group relative bg-[#112240] rounded-lg transform transition-all duration-300 hover:-translate-y-2 hover:shadow-xl hover:shadow-[#64ffda20]">
              <div className="p-6">
                ...
                <div className="relative overflow-hidden rounded-lg">
                  <img
                    src="path/to/film-searcher-image.jpg"
                    alt="Film Searcher"
            ...
            <div className="group relative bg-[#112240] rounded-lg transform transition-all duration-300 hover:-translate-y-2 hover:shadow-xl hover:shadow-[#64ffda20]">
              <div className="p-6">
                <div className="relative overflow-hidden rounded-lg">
                  <img
                    src="path/to/pig-game-image.jpg"
                    alt="Pig Game"
                    className="w-full h-48 object-cover rounded-lg transform transition-transform duration-500 group-hover:scale-110"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#0a192f] via-transparent to-transparent" />
            ...
            <div className="group relative bg-[#112240] rounded-lg transform transition-all duration-300 hover:-translate-y-2 hover:shadow-xl hover:shadow-[#64ffda20]">
              <div className="p-6">
                ...
                <div className="mt-6 flex gap-4">
                  <a
                    href="https://github.com/banadawit/ReactJs-and-Tailwind-CSS-Website"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center px-4 py-2 bg-[#233554] text-[#64ffda] rounded-md hover:bg-[#64ffda] hover:text-[#0a192f] transition-all"
                  >
